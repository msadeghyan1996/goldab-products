    ...
    <div class="container">
        <div class="about-hero-inner">
            <div class="about-copy">
                ...
                <h1>پیشینه‌ای حرفه‌ای در طلای آب‌شده و جواهر</h1>
                <p>
                    ایران گلد با تکیه بر تجربه عملی در بازار طلا، سال‌هاست در حوزه طلای آب‌شده، مصنوعات طلا و جواهر فعالیت می‌کند.
